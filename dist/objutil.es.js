...
export { is, own, isPOJO, isIterable, isPrimitive, deepIt, forEach, map, some, every, get, got, set, unset, ensure, invert, assign, assign as extend, merge, remove, pick, defaults, isEqual, visit, filter };
